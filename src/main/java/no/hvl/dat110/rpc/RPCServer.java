...
public class RPCServer {
	...
	public void run() {
		...
		while (!stop) {
			...
			byte[] requestmsg_bytes = RPCUtils.decapsulate(requestmsg.getData());
			...
			byte[] processed = service.invoke(requestmsg_bytes);
			
			byte[] encoded = RPCUtils.encapsulate(rpcid, processed);
